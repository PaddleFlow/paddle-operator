...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RuntimeStates) DeepCopyInto(out *RuntimeStates) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RuntimeStates.
func (in *RuntimeStates) DeepCopy() *RuntimeStates {
	if in == nil {
		return nil
	}
	out := new(RuntimeStates)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SampleSetStatus) DeepCopyInto(out *SampleSetStatus) {
	*out = *in
	...
	if in.JobsName != nil {
		in, out := &in.JobsName, &out.JobsName
		*out = new(JobsName)
		**out = **in
	}
}
